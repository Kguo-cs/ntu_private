...
#
#
# data_directory = "/home/ke/code/sim/src/waymo_data/full/training_map2_03_light"
#
# files = os.listdir(data_directory)[::10]
#
# shape=[]
# type=[]
#
...
print(torch.quantile(lengths, 0.999))
print(torch.quantile(widths, 0.999))

print(torch.bincount((lengths*10).to(torch.long)))
print(torch.bincount((widths*10).to(torch.long)))
