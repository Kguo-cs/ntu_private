        ...
        if self.iq_learn:
            ...
            if self.use_gail:
                ...
                if self.encoder.use_value:
                    ...
                    v_denorm = v_denorm.masked_scatter(agent_valid_mask[:,:-1].transpose(0,1), value)
                    ...
                    if self.use_lcf:
                        ...
                        nei_value_pred = nei_value_pred.masked_scatter(agent_valid_mask[:, :-1].transpose(0, 1), nei_value)
