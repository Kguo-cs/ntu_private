...
def configure_optimizers(model, muon_lr=0.02,muon_momentum=0.95,
    ...
    optim_groups = [
        {'params': hidden_params, 'lr': muon_lr, 'momentum': muon_momentum, 'optimizer_name': 'muon'},
        {'params': other_params, 'lr': adam_lr, 'weight_decay': weight_decay, 'optimizer_name': 'adamw'}
    ]
    ...
    optimizer1 = Muon(hidden_params, lr=muon_lr, momentum=muon_momentum)
    optimizer2 = optim.AdamW(other_params, lr=adam_lr, weight_decay=weight_decay, betas=(adam_beta1, adam_beta2))
