        ...
        if self.discriminator:
            if self.use_edge_feature:
                ...
                if not self.use_ego_loop:
                    ...
                    rewards=torch.minimum(rewards,ego_rewards)#ego_rewards+2*rewards#rewards+ego_rewards#+torch.zeros_like(torch.minimum(ego_rewards,rewards)#)#rewards+ego_rewards#
