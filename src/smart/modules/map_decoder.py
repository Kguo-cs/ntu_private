...
class SMARTMapDecoder(nn.Module):
    ...
    def forward(self, tokenized_map: Dict):
        ...
        #
        # mask=(map_type==4) | (map_type==6) | (map_type==9) | (map_type==7) # | (map_type==1)
        ...
        mask = (map_type == 4) | (map_type == 5) #(map_type==6) | (map_type==7)  | (map_type==4) #| (map_type==9) | (map_type==4) | # | (map_type==7) #(map_type == 4) | (map_type == 5)
