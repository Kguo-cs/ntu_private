...
tokenized_agent, scenario_path_A, disc_val_A, pred,tokenized_agent_B, scenario_path_B, disc_val_B, pred_B=torch.load("/home/ke/code/catk/src/waymo_data/plot/pred_all.pt")
