...
def run(cfg: DictConfig) -> None:
    ...
    if cfg.action == "fit":
        ...
        trainer.fit(model=model, datamodule=datamodule, ckpt_path=cfg.get("ckpt_path"))#cfg.get("ckpt_path")), ckpt_path='./logs/AIRL152_learnmap_arn10_pred/2025-10-20_06-13-19/sim/9vtkji4b/checkpoints/last.ckpt'
