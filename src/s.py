...
def compare_with_4090(
    baseline_file="/home/ke/code/sim/src/waymo_data/full/baseline_4090.pt",
    device="cuda",
):
    # 同样关闭 TF32 等，尽量一致
...
print((0.097574+0.11958+0.10813+0.058877+0.15181+0.37306+0.030566)/7)

print((0.10279+0.11516+0.11207+0.05987+0.14903+0.3731+0.056709)/7)