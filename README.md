...
rsync -avz /home/ke/code/catk/src/waymo_data/full/testing_map2 ke@10.87.216.98:~/code/sim/src/waymo_data/full/
...
rsync -avz ke@10.87.114.128:~/code/sim/src/logs/bc56_routeneg1/2025-10-06_09-44-55/bc/9h4bxeud/checkpoints/epoch=62-step=547911.ckpt ./
...
rsync -avz ke@10.87.216.98:~/code/sim/src/logs/bc56_routeneg1/2025-10-06_09-44-55/bc/9h4bxeud/checkpoints/epoch=62-step=547911.ckpt ./
...
rsync -avz -e "ssh -p 32884" guoke@sprl-server9.dynip.ntu.edu.sg:~/sim/src/logs/AIRL152_learnmap_arn10_predvalidrollout0_355/2025-10-29_08-19-09/sim/daukhctv/checkpoints/epoch=12-step=41652.ckpt ./
...
conda activate catk
git pull
setsid  nohup torchrun --nproc_per_node=4  -m run1 trainer=ddp  >  1.log 2>&1 &

CUDA_VISIBLE_DEVICES=2,3 torchrun --nproc_per_node=2 --master_port=29501  -m run trainer=ddp


CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node=2 --master_port=29504  -m run trainer=ddp
