...
rsync -avz -e "ssh -p 32884" guoke@sprl-server9.dynip.ntu.edu.sg:~/sim/src/pred_z.pt ./
...
CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node=4 --master_port=29500  -m run trainer=ddp
