...
rsync -avz /home/ke/code/catk/src/waymo_data/full/bird_train107_entry44max_noreplace  ke@10.87.114.128:~/keguo/sim/src/waymo_data/full/ 

rsync -avz /home/ke/code/catk/src/waymo_data/full/bird_train107_entry44max_noreplace ke@10.87.216.98:~/code/sim/src/waymo_data/full/

rsync -avz -e "ssh -p 32884" /home/ke/code/catk/src/waymo_data/full/bird_train107_entry44max_noreplace guoke@sprl-server9.dynip.ntu.edu.sg:~/sim/src/waymo_data/full/
...
CUDA_VISIBLE_DEVICES=2,3 torchrun --nproc_per_node=2 --master_port=29503  -m run trainer=ddp >  23.log 2>&1 & 

CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node=2 --master_port=29501  -m run1 trainer=ddp >  2.log 2>&1 & 

CUDA_VISIBLE_DEVICES=3  python run3.py >  3.log 2>&1 & 
